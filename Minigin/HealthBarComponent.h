...
{
public:
	HealthBarComponent(dae::TextComponent* TargetText,HealthComponent* healthref, const std::string& HealthIcon, 
		glm::ivec2 spacing = { 10,0 }) : m_TextDisplay(TargetText), nm_pHealthComp(healthref), m_spacing(spacing)
	{
